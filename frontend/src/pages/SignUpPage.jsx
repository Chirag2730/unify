...
const SignUpPage = () => {
  ...
  const handleVerifyOTP = (data) => {
    console.log("🔍 Verifying OTP:", data, "for userId:", userId);
    if (verifyOTPMutation) {
      // Send userId and otp as your backend expects
      verifyOTPMutation({ userId: userId, otp: data.otp });
    } else {
      console.error("verifyOTPMutation is not available");
    }
  };

  const handleResendOTP = () => {
    console.log("📧 Resending OTP for userId:", userId);
    if (resendOTPMutation) {
      // Send userId as your backend expects
      resendOTPMutation({ userId: userId });
    } else {
      console.error("resendOTPMutation is not available");
    }
  };
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-sm opacity-70">
                    Join Unify and start your language learning adventure!
                  </p>
                </div>
